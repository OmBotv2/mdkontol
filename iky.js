...
case 'chiisaihentai':
            ...
            if (!isPremium) return sendButMessage(from, harusvip, goprem, torem, {quoted:freply})
              ...
              buttonsMessage = {footerText:'@ M I Z U K I  B O T', imageMessage: imageMsg,
              contentText:`Follow @by Alwi ofc`,buttons,headerType:4}
              prep = await dimas.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              dimas.relayWAMessage(prep)
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await dimas.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Crated by Alwi ofc', imageMessage: imageMsg,
...
case 'memeindo': 
                ...
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
               imageMsg = (await dimas.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Crated by Alwi ofcs', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await dimas.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              dimas.relayWAMessage(prep)
                break
...
┗⬡ `
 ...
 ♥️ SULAWESI SELATAN\n\n♥️ Alwi Ofcr`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
                        ...
                        buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Follow @by Alwi ofc`},type:1}]
